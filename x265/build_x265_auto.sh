...
DOWNLOAD_URL="https://1drv.ms/u/s!AsYziax1Q91rmWqVjlTeeSKWhX36"
...
EXE_PATH=${BUILD_DIR}/${TARGET_ARCH}/x265/build/msys/8bit/x265_${X265_VER}_${TARGET_ARCH}.exe
cp -f ${BUILD_DIR}/${TARGET_ARCH}/x265/build/msys/8bit/x265.exe ${EXE_PATH}
7z a -tzip -mx=9 -mfb=256 -mpass=15 -mmt=off "${BUILD_DIR}/temp/x265_${X265_VER}_${TARGET_ARCH}.zip" ${EXE_PATH} ${GPL_LICENSE_PATH}
...
echo "x265 ${X265_VER} をビルドしバイナリを更新しました。 → ${DOWNLOAD_URL}"
read -p "ok? (y/N): " yn
